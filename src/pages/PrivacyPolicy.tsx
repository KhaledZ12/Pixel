...
const PrivacyPolicy = () => {
    return (
        <div className="min-h-screen bg-background">
            <Helmet>
                <title>سياسة الخصوصية | بيكسل للتسويق الإلكتروني</title>
                <meta name="description" content="تعرف على سياسة الخصوصية في بيكسل وكيف نقوم بجمع وحماية بياناتك الشخصية عند استخدام موقعنا وخدماتنا." />
                <link rel="canonical" href="https://pixelmarketng.com/privacy-policy/" />
                <meta property="og:url" content="https://pixelmarketng.com/privacy-policy/" />
            </Helmet>
            <Header />

            <main className="container mx-auto px-4 py-24 lg:py-32">
                <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
                    <h1 className="text-3xl lg:text-4xl font-bold text-center mb-8">سياسة الخصوصية</h1>
                    ...
                    <div className="bg-card border border-border rounded-2xl p-6 md:p-10 shadow-sm space-y-6 text-foreground text-left" dir="ltr">
                        ...
                        <p>Effective date: 2030-03-01</p>

                        <p>1. <b>Introduction</b></p>

                        <p>Welcome to <b> Pixel</b>.</p>

                        <p><b>Pixel</b> (“us”, “we”, or “our”) operates <b>https://pixelmarketng.com/</b> (hereinafter referred to as <b>“Service”</b>).</p>

                        <p>Our Privacy Policy governs your visit to <b>https://pixelmarketng.com/</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
                        ...
                        <p><b>SERVICE</b> means the https://pixelmarketng.com/ website operated by Pixel.</p>
                        ...
                        <p>Pixel uses the collected data for various purposes:</p>
                        ...
                        <p>If you are located outside The Arab Republic of Egypt and choose to provide information to us, please note that we transfer the data, including Personal Data, to The Arab Republic of Egypt and process it there.</p>

                        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>

                        <p>Pixel will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                        ...
                        <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>info@pixel.com</b>.</p>
                        ...
                        <p>0.4. users are able to change their personal information by emailing us at <b>info@pixel.com</b>.</p>
                        ...
                        <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>info@pixel.com</b>.</p>
                        ...
                        <p>For example, the outlined <a href="https://policymaker.io/privacy-policy/" className="text-primary hover:underline">privacy policy</a> has been made using <a href="https://policymaker.io/" className="text-primary hover:underline">PolicyMaker.io</a>, a free tool that helps create high-quality legal documents. PolicyMaker’s <a href="https://policymaker.io/privacy-policy/" className="text-primary hover:underline">privacy policy generator</a> is an easy-to-use tool for creating a <a href="https://policymaker.io/blog-privacy-policy/" className="text-primary hover:underline">privacy policy for blog</a>, website, e-commerce store or mobile app.</p>
                        ...
                        <p>If you have any questions about this Privacy Policy, please contact us by email: <b>info@pixel.com</b>.</p>

                        <p style={{ marginTop: '5em', fontSize: '0.7em' }}>This <a href="https://policymaker.io/privacy-policy/" className="text-primary hover:underline">Privacy Policy</a> was created for <b>https://pixelmarketng.com/</b> by <a href="https://policymaker.io" className="text-primary hover:underline">PolicyMaker.io</a> on 2030-03-01.</p>
                    </div>
                </div>
            </main>
